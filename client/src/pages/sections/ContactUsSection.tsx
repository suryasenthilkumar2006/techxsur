          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="font-['Poppins',sans-serif] text-white/80 text-base">
                  <span className="font-medium">Charu Dharshana R</span> –  <a href="mailto:charudharshana49@ieee.org" className="block hover:underline">
                      charudharshana49@ieee.org
                    </a>
                </p>
                <p className="font-['Poppins',sans-serif] text-white/80 text-base">
                  <span className="font-medium">Parveen Begum T</span> –   <a href="mailto:parveenbegumt@ieee.org" className="block hover:underline">
